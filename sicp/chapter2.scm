...
;; example Ex. 2.58 part a; skipping part b for now
;; Infix, fully parenthesed
...
;; a)
;;
;; number? and variable? directly check the type of their arguments,
;; while the operator can be understood as a type tag for the other
;; checks.



;; b), c)
(define (install-deriv-arithmetics-package)
  (define (=number? exp num) (and (number? exp) (= exp num)))
  ...
  (define (multiplier p) (car p))
  (define (multiplicand p) (accumulate make-product 1 (cdr p)))
...
;; Chaper 2.5   Systems with Generic Operations
;;
;;
...
;; get|put as implemented in Chapter 3
(define (make-table)
